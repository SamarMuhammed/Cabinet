...
class globalPricesDetailsScreen extends StatefulWidget {
  ...
  final String unit;
  final String name;
  const globalPricesDetailsScreen(
      {Key? key,
  ...
  @override
  State<globalPricesDetailsScreen> createState() =>
      _globalPricesDetailsScreenState();
}
...
class _globalPricesDetailsScreenState extends State<globalPricesDetailsScreen> {
  ...
  Future<GlobalPriceChartData> loadChartData(duration) async {
    ...
    var chartData =
        await PricesService().getglobalChartData(widget.subCatID!, duration);

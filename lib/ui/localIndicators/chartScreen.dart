...
class ChartView extends StatefulWidget {
  ...
  const ChartView({Key? key, required this.subCatID, required this.subCatName})
      : super(key: key);
      ...
      setState(() {
          ...
          if (data.indicators![0].chartTypeId == 2) // lineChart
          {
            seriesData = [
              LineSeries<listItem, String>(
                ...
                yValueMapper: (listItem ind, _) =>
                    double.parse((ind.value).toStringAsFixed(2)),
        ...
        } else if (data.chartID == 2) ////group
        {
          ...
          for (int i = 0; i < indicators.length; i++) {
            ...
            {
              item = LineSeries<listItem, String>(
                dataSource: items,
            ...
            } else if (indicators[i].chartTypeId == 1) // column {
            {
              ...
              item = ColumnSeries<listItem, String>(
                dataSource: items,
                markerSettings: MarkerSettings(
                    isVisible: true,
                    // Marker shape is set to diamond
            ...
            } else if (data.indicators![i].chartTypeId == 4) // stackedChart
            {
              ...
              item = StackedColumnSeries<listItem, String>(
                dataSource: items,
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: AutoSizeText(
                                          data.indicators![0].unit.toString(),
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                  ...
                                  child: Padding(
                                    padding:
                                        EdgeInsets.only(top: 8.0.r, left: 10.r),
                                    child: AutoSizeText(
                  ...
                  if (data.indicators!.length > 1)
                    SingleChildScrollView(
                      ...
                      child: Card(
                        ...
                        child: Container(
                          padding:
                              EdgeInsets.only(right: 8, left: 8, bottom: 0).r,
                          child: Row(

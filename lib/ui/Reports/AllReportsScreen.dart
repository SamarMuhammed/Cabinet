...
class AllReportsScreen extends StatefulWidget {
  ...
  const AllReportsScreen({Key? key, required this.selectedTopics})
      : super(key: key);
...
class _AllReportsScreenState extends State<AllReportsScreen> {
  ...
  Future<void> _fetchPage(int pageKey) async {
    try {
      final newItems = await ReportsService()
          .getAllReports(topicID: widget.selectedTopics, page: pageKey);

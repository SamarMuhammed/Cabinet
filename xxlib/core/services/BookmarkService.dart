...
class BookmarkService {
  ...
  /////////getbookmark
  Future<List<SelectedData>> getBookmark(
    ...
    try {
      ...
      Response response =
          await _dio.post(DioBaseService().BASE_URL + "bookmark/", data: data);
  ...
  /////////searchbookmark
  Future<List<SelectedData>> searchBookmark(
      {required int mainCatID,
      required String mainCatName,
    ...
    try {
      ...
      Response response = await _dio.post(
        DioBaseService().BASE_URL + 'bookmark/search/',
        data: data,
      );

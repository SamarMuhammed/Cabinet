...
class TopicService {
  Future<List<Topic>> getTopics() async {
    ...
    try {
      ...
      Response response = await _dio.get(DioBaseService().BASE_URL + "topics/");
  ...
  Future<List<Topic>> getSavedTopics(id) async {
    ...
    try {
      ...
      Response response =
          await _dio.get(DioBaseService().BASE_URL + "topics/savedtopics/$id");
  ...
  Future<bool> addUserTopic(TopicPost t) async {
    ...
    try {
      ...
      Response response = await dioService
          .getDio()
          .post(dioService.BASE_URL + 'topics/save', data: t.toJson());

  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("اتصل بنا",style:TextStyle(fontSize: 17,fontFamily: 'Cairo'),),
                  ...
                  children: [
                    ...
                    Center(
                      child: Padding(
                        ...
                        child: Text(
                          ...
                          'عنوان : 1 ش مجلس الشعب - القصر العيني - القاهرة - مصر',
                          textAlign: TextAlign.center,
                    ...
                    Center(
                      child: Padding(
                        ...
                        child: Text(
                          ...
                          textAlign: TextAlign.center,
                          style: TextStyle(color: Colors.black.withOpacity(0.6),fontFamily: 'Cairo'),
                        ),
                      ),
                    ),
                    Center(
                    ...
                    Row(
                      children: [
                        Center(
                          child: Padding(
                            padding: const EdgeInsets.only(right:175,left:116,top:10),
                            child: RichText(
                              // textAlign: TextAlign.center,

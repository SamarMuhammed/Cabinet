                ...
                title: Center(
                    ...
                    Column(
                      children: [
                        ...
                        AutoSizeText(widget.data.name.toString(),
                        ...
                        Padding(
                          ...
                          child: AutoSizeText(' ${widget.data.indicators![widget.data.indicators!.length-1].value.toString()} ${widget.data.indicators![widget.data.indicators!.length-1].unit.toString() }',
                       ...
                       Row(
                         ...
                         children: [
                           ...
                           Expanded(
                               flex: 4,
                               child:  AutoSizeText(widget.data.indicators![0].name!,
                                 style: TextStyle(
                           ...
                           Expanded(
                               ...
                               child: Row(
                                 children: [
                                   if( widget.data.indicators![widget.data.indicators!.length-3].value! >=0)
                                   ...
                                   AutoSizeText(
                                     ...
                                     style:  TextStyle(fontSize: 15.sp,color:  widget.data.indicators![widget.data.indicators!.length-3].value! >=0 ? Colors.red
                                         :Colors.green,),minFontSize: 15,maxFontSize: 17,)
                                 ],
                               )),
                         ],
                       ),
                    Row(
                      ...
                      children: [
                        ...
                        Expanded(
                            ...
                            child: AutoSizeText(widget.data.indicators![1].name!,
                              style: TextStyle(
                                  fontSize: 15.sp, color: Color(0xff0D005F)),minFontSize: 15,maxFontSize: 17,)),
                        Expanded(
                            flex: 2,
                            child: Row(
                              children: [
                                if( widget.data.indicators![widget.data.indicators!.length-2].value! >=0)
                                  Icon(Icons.arrow_upward,
                                      color: Colors.red,size: 14)
                                else
                                ...
                                AutoSizeText(
                                  ...
                                  style:  TextStyle(fontSize: 15.sp,color: widget.data.indicators![widget.data.indicators!.length-2].value! >=0 ? Colors.red
                                      :Colors.green),minFontSize: 15,maxFontSize: 17,)
                              ],
                            ))
                      ],

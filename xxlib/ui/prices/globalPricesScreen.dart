                    ...
                    SingleChildScrollView(
                      ...
                      child: Padding(
                        ...
                        child: Card(
                          ...
                          child: Container(
                            padding: EdgeInsets.only(right: 5,left: 5,bottom: 0).r,
                            child: Row(
                              ...
                              [for (final cat in subCategories)
                                ...
                                GestureDetector(
                                    ...
                                    ChoiceChip(label: Text(cat.name.toString()),selected: cat.isSelected!
                                        ,selectedColor: const Color(0xff8F3F71),
                                        labelStyle: TextStyle( color:selectedCat == cat.id!?Colors.white:Colors.black45 ,
                                            fontSize: 17.sp),
                                        ...
                                        backgroundColor:selectedCat == cat.id!?Color(0xff8F3F71):Colors.white)
                ...
                title: Center(
                    ...
                    Column(
                      children: [
                        ...
                        AutoSizeText(indicators[index].name.toString(),
                        ...
                        AutoSizeText(' ${indicators[index].value.toString()}',
                          style:  TextStyle(color:Color(0xff8F3F71),
                              fontSize: 18.sp,
                              //   fontFamily: 'Cairo',
                              fontWeight: FontWeight.bold
                          ),
                        ...
                        AutoSizeText('${indicators[index].unit.toString() }',
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              flex: 4,
                              child:  AutoSizeText("نسبة التغير اليومي",
                                style: TextStyle(
                                    fontSize: 15.sp, color: Color(0xff0D005F)),minFontSize: 15,maxFontSize: 17,),
                            ),
                            Expanded(
                                flex: 2,
                                child: Row(
                                  children: [
                                    double.parse(indicators[index].dailyPercentage.toString()) >=0 ? Icon(Icons.arrow_upward_outlined,color: Colors.red,size: 20):Icon(Icons.arrow_downward,color: Colors.green,size: 20),



                                    AutoSizeText(
                                      ' ${indicators[index].dailyPercentage.toString()} %',
                                      style:  TextStyle(fontSize: 15.sp,color: double.parse(indicators[index].dailyPercentage.toString()) >=0?Colors.red:Colors.green ,fontWeight: FontWeight.bold
                                      ),minFontSize: 15,maxFontSize: 17,)
                                  ],
                                )),
                          ],
                        ),
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                                ...
                                child: AutoSizeText("نسبة التغير السنوي",
                                  style: TextStyle(
                                      fontSize: 15.sp, color: Color(0xff0D005F)),minFontSize: 15,maxFontSize: 17,)),
                            Expanded(
                                flex: 2,
                                child: Row(
                                  children: [
                                    double.parse(indicators[index].yearlyPercentage.toString()) >= 0 ? Icon(Icons.arrow_upward_outlined, color: Colors.red,size: 20):Icon(Icons.arrow_downward,color: Colors.green,size: 20),



                                    AutoSizeText(
                                      ' ${ indicators[index].yearlyPercentage.toString()} %',
                                      style:  TextStyle(fontSize: 15.sp,color:double.parse(indicators[index].yearlyPercentage.toString()) >= 0?Colors.red:Colors.green,fontWeight: FontWeight.bold
                                      ),minFontSize: 15,maxFontSize: 17,)
                                  ],
                                ))
                          ],
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: AutoSizeText(
                                            ...
                                            style:  TextStyle(
                                                fontSize: 15.sp),minFontSize: 15,maxFontSize: 17,),
                                        )
                                      ]),
                                ),
                              ),

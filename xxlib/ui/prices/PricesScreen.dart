...
import 'package:reidsc/ui/prices/PricesDetailsScreen.dart';
...
class _PricesScreenState extends State<PricesScreen> {
  ...
  late int length = 0;
  Future<List<PricesCategory>> loadPricesCat() async {
  ...
  loadPricesData(int id) async {
    indicators = await PricesService().getLocalPrices(id: id);
    setState(() {
      selectedCat = id;
...
//print(indicators[0].name);
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
        future: subCategories.isEmpty ? loadPricesCat() : null,
          ...
          child: GestureDetector(
            onTap: () {
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (ctx) => PricesDetailsScreen(
              ...
              child: ListTile(
                ...
                title: Center(
                  ...
                  children: [
                    ...
                    AutoSizeText(
                      ' ${indicators[index].value.toString()}',
                      style: TextStyle(
                    ...
                    AutoSizeText(
                      '${indicators[index].unit.toString()}',
                      style: TextStyle(
                            ...
                            child: Row(
                              children: [
                                ...
                                AutoSizeText(
                                  ...
                                  style: TextStyle(
                                      fontSize: 15.sp,
                                      color: double.parse(indicators[index]
                                                  .dailyPercentage
                                                  .toString()) >=
                                              0
                                          ? Colors.red

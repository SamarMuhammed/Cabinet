                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      padding: EdgeInsets.only(
                              left: 24.0, right: 23.0, top: 5, bottom: 0)
                          .r,
                      ...
                      child: TextFormField(
                        ...
                        validator: (text) {
                          ...
                          if (text.length < 10) {
                            nameValid = false;
                            return 'الحد الأدنى لعدد الحروف 10';
                          }
                          if (text.length > 25) {
                            return 'الحد الأفصي لعدد الحروف 25';
                          }
                        ...
                        decoration: InputDecoration(
                          ...
                          focusedBorder: OutlineInputBorder(
                            borderSide: BorderSide(
                                color: Color(0xff21212133), width: 4.0.w),
                    ...
                    Padding(
                      padding: EdgeInsets.only(
                              left: 24.0, right: 23.0, top: 10, bottom: 0)
                          .r,
                      //padding: EdgeInsets.symmetric(horizontal: 15),
                      child: TextFormField(
                    ...
                    Padding(
                      padding: EdgeInsets.only(right: 10, left: 10, top: 7).r,
                      child: SizedBox(
                        width: double.infinity,
                        child: Container(
                      ...
                      child: Container(
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: UserGenderList.map((data) => Flexible(
                                  child: RadioListTile(
                                    dense: true,
                      ...
                      children: [
                        Expanded(
                          child: Container(
                            height: 50.0.h,
                            child: Padding(
                              padding: EdgeInsets.only(right: 7, left: 13).r,
                              child: Row(
                                mainAxisSize: MainAxisSize.min,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                // WAY 1

                                children: UserAgeList.map((data) => Flexible(
                                      child: RadioListTile(
                                        dense: true,
                                        activeColor: Colors.blue,
                                        contentPadding: EdgeInsets.zero,
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed:
                              nameValid && emailValid ? _onSaveUSer : null,
                          child: Text(
                            'تأكيد',
                            style:
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        await UserService().addUser(u).then((res) => {
              // print(res.data)
              showRes(
                  res.data["status"], res.data["message"], res.data["content"])
            });
      } catch (e) {
        showDialog(
          context: context,
          builder: (BuildContext context) {
            return AlertDialog(
              //title: new Text("Alert!!"),
              content: new Text("حدث خطأ يرجي إعادة المحاولة"),
              actions: <Widget>[
                new ElevatedButton(
                  child: new Text("OK"),
                  onPressed: () {

  ...
  Future<List<PricesCategory>> getMainPricesCategories()async{
    ...
    try {
      ...
      Response response = await _dio.get(
          DioBaseService().BASE_URL + "prices/cat");
...
/////////////////////////get latest prices///////////////////////////
  Future<List<PricesDataall>> getLatestPrices()async{
    ...
    try {
      ...
      Response response = await _dio.get(
          DioBaseService().BASE_URL + "prices/latest");
...
//////////////////////////get local prices///////////////////////////
  ...
  //  var data={"topicID": topicID,"page": page};
    try {
      ...
      Response response = await _dio.get(
          DioBaseService().BASE_URL + "prices/local/data/$id");
  ...
  Future<List<PricesDataall>> getGlobalPrices({required int id})async{
    ...
    try {
      ...
      Response response = await _dio.get(
          DioBaseService().BASE_URL + "prices/global/data/$id");
...
///////////////local charts///////////////////////////
  ...
  Future<PriceDataChart> getChartData(int subID,int duration)async{
    ...
    try {
      ...
      Response response = await _dio.post(
          DioBaseService().BASE_URL + "prices/local/chart/",data: {"id":subID,"Duration":duration});
  ...
  Future<GlobalPriceChartData> getglobalChartData(int subID,int duration)async{
    ...
    try {
      ...
      Response response = await _dio.post(
          DioBaseService().BASE_URL + "prices/global/chart/",data: {"id":subID,"Duration":duration});

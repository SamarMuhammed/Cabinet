...
class LocalIndService{
  ...
  Future<List<IndCategory>> getMainIndCategories()async{
    ...
    try {
      ...
      Response response = await _dio.get(
          DioBaseService().BASE_URL + "indcategories/");
  ...
  Future<List<IndCategory>> getLocIndCategories(String topicIDs)async{
    ...
    try {
      Dio _dio = DioBaseService().getDio();
       print("URRRRRL");
print(  DioBaseService().BASE_URL + "indcategories/local/topic?topicsId="+topicIDs);
      Response response = await _dio.get(
          DioBaseService().BASE_URL + "indcategories/local/topic?topicsId="+topicIDs);
  ...
  Future<List<LocalIndSubCategory>> getLocIndSubCategories(int id)async{
    ...
    try {
      ...
      Response response = await _dio.get(
          DioBaseService().BASE_URL + "indcategories/local/subcat/"+id.toString());
  ...
  Future<IndChartData> getLocIndChartData(int subCatID)async{
    ...
    try {
      ...
      Response response = await _dio.get(
          DioBaseService().BASE_URL + "indcategories/local/chart/"+subCatID.toString());

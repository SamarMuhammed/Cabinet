...
class TabBarWidget extends StatefulWidget {
  ...
  const TabBarWidget({Key? key, required this.tabs, Color? indicatorColor,
    BoxDecoration? indicator, Color? labelColor,
    Color? unselectedLabelColor, TextStyle? labelStyle,

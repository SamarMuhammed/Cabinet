...
Future<NewsVM> getNewsByID(id)
async {
  var news =await NewsService().getNewsByID(id:id);
  return news!;
}

Future<Reports> getReportByID(id)
async {

                    ...
                    Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: AutoSizeText(' ${indicators[index].value.toString()} ${indicators[index].unit.toString() }',
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                                ...
                                child: Row(
                                  children: [
                                    double.parse(indicators[index].dailyPercentage.toString()) >=0 ? Icon(Icons.arrow_upward_outlined,color: Color(0xff23244B),size: 20):Icon(Icons.arrow_downward,color: Color(0xff23244B),size: 20),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                                ...
                                child: Row(
                                  children: [
                                    double.parse(indicators[index].yearlyPercentage.toString()) >= 0 ? Icon(Icons.arrow_upward_outlined, color: Color(0xffE79D4F),size: 20):Icon(Icons.arrow_downward,color: Color(0xffE79D4F),size: 20),



                                    AutoSizeText(
                                      ' ${ indicators[index].yearlyPercentage.toString()} %',
                                      style:  TextStyle(fontSize: 15.sp,color:Color(0xffE79D4F),fontWeight: FontWeight.bold
                                      ),minFontSize: 15,maxFontSize: 17,)
                                  ],
                                ))
                          ],

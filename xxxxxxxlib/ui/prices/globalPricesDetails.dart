...
class globalPricesDetailsScreen extends StatefulWidget {
  ...
  final String unit;
  final String name;
  const globalPricesDetailsScreen({Key? key, required this.subCatID, required this.dailyPrice, required this.yearlyPrice,required this.unit,required this.name}) : super(key: key);

  @override
  State<globalPricesDetailsScreen> createState() => _globalPricesDetailsScreenState();
}

class _globalPricesDetailsScreenState extends State<globalPricesDetailsScreen> {
  ...
  Future<GlobalPriceChartData> loadChartData(duration) async{
    _tooltipBehavior = TooltipBehavior(enable: true, shouldAlwaysShow: true);
    var completer = Completer<GlobalPriceChartData>();

    items=[];
    govItems=[];
    print("chart"+widget.subCatID.toString());
    var chartData = await PricesService().getglobalChartData(widget.subCatID!,duration);
...
//print(DateTime.parse( m.date!.toString()));
    ...
    completer.complete(await PricesService().getglobalChartData(widget.subCatID!,duration));
            ...
            if ( data!=null && seriesData.length >0 ) {
              return Scaffold(
                  appBar: AppBar(
                    ...
                    title: Text(widget.name.toString(),style:GoogleFonts.tajawal(textStyle: TextStyle(fontSize: 17.sp)
                    ),),
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          GestureDetector(
                                              ...
                                              child: AutoSizeText("شهر", style: TextStyle(fontSize: 17.sp,
                                                  fontWeight: FontWeight.bold,
                                          ...
                                          GestureDetector(
                                              ...
                                              child: AutoSizeText("6 أشهر", style: TextStyle(fontSize: 17.sp,
                                                  fontWeight: FontWeight.bold,
                                          ...
                                          GestureDetector(
                                              ...
                                              child: AutoSizeText("سنة", style: TextStyle(fontSize: 17.sp,
                                                  fontWeight: FontWeight.bold,
                              ...
                              SizedBox(
                                ...
                                SfCartesianChart(
                                    ...
                                    primaryYAxis: NumericAxis(
                                      //    minimum: 0,
                                        title: AxisTitle(text: widget.unit,textStyle:GoogleFonts.tajawal(textStyle: TextStyle(fontSize: 17))),
                                    ...
                                    legend: Legend(
                                        ...
                                        isVisible: true,
                                      textStyle: GoogleFonts.tajawal( textStyle: TextStyle(fontSize: 16.sp,), ),

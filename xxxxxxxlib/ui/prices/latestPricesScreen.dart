...
//    print("chart"+subCategories[selectedSubcat].id!.toString());
    ...
    var chartData = await PricesService().getglobalChartData(indicators[selectedSubcat].id!,duration);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(" احدث الاسعار",style:GoogleFonts.tajawal(textStyle: TextStyle(fontSize: 17.sp)
          ),),
           ...
           /* Container(
            ...
            Container(
               ...
               //   width: MediaQuery.of(context).size.width/2,
                  ...
                  color:( selectedSubcat==index)? Color(0xffF5E0F2).withOpacity(0.7):Colors.white,
                  child: Column(
                  ...
                  child:  Padding(
                    ...
                    child: AutoSizeText(indicators[index].name.toString(),textAlign:TextAlign.center,style: TextStyle(color: Color(0xff0D005F),fontWeight: FontWeight.bold,fontSize: 15.sp),minFontSize: 18,maxFontSize: 20,),
                  ),
                  flex:12
                  )
                  ...
                  ,
                    ...
                    Row(
                        ...
                        children: <Widget>[
                          AutoSizeText(indicators[index].value.toString(),style: TextStyle(color: Color(0xff8F3F71),fontSize: 30.sp,fontWeight: FontWeight.bold),minFontSize: 18,maxFontSize: 20,),
                    ...
                    Container(
                      ...
                      child: Row(
                          ...
                          children:[
                            ...
                            Expanded(child: AutoSizeText(indicators[index].unit.toString(),textAlign:TextAlign.center,style:GoogleFonts.tajawal(textStyle: TextStyle(fontSize: 17),color: Colors.black45),minFontSize: 18,maxFontSize: 20,)),
                    ...
                    Row(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Icon(Icons.date_range_rounded,size:15,color: Colors.black45),
                        AutoSizeText(
                          indicators[index].date.toString(),
                          style:GoogleFonts.tajawal(textStyle: TextStyle(fontSize: 17,color: Colors.black45)),
            ...
            Container(
              alignment: Alignment.topRight,
              child: Text(" المؤشرات",style: TextStyle(color: Colors.black45,fontSize: 20.sp,fontWeight: FontWeight.bold)),
            ),
            Padding(
                    ...
                    child: Row(
                      children: [
                        Expanded(
                            ...
                            child: Column(
                              children: [
                                Center(child: Text("نسبة التغير",
                                  style: TextStyle(color: Color(0xff0D005F),
                                      fontSize: 18.sp),)),

                              ],
                            )),
                        Expanded(  flex:2,child: VerticalDivider(color: Colors.black45,thickness: 2,)),
                        Expanded(
                            flex:4,
                            child: Center(
                              child: Column(
                                children: [
                                  Row(
                                    children: [
                                      Icon(Icons.arrow_downward,color: Color(0xffE79D4F),)
                                      ,
                                      Center(
                                        child: Text('${indicators[selectedSubcat].dailyPercentage.toString()} %'
                                            ,textAlign: TextAlign.center,style:  TextStyle(fontSize: 22.sp,
                      ...
                      Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              AutoSizeText("المدى:",style: TextStyle(fontSize: 17.sp,fontWeight: FontWeight.bold),minFontSize: 18,maxFontSize: 20,))),

                              Expanded(flex: 2, child: Center(child:
                              GestureDetector(
                                  onTap:() {
                                    setState(() => getStockChartData(selectedSubcat,7));
                                  } ,
                                  child: AutoSizeText("أسبوع",
                                    style: TextStyle(
                                        fontWeight: FontWeight.bold,fontSize: 17.sp,
                                        color: selectedDuration == 7 ? Color(0xff8F3F71) : Colors.black87),
                                minFontSize: 18,maxFontSize: 20,  )))),

                              Expanded(flex: 2, child: Center(child:
                              GestureDetector(
                                  onTap:() {
                                    setState(() => getStockChartData(selectedSubcat,30));
                                  },
                                  child: AutoSizeText("شهر",style: TextStyle( fontSize: 17.sp,  fontWeight: FontWeight.bold,
                                      color: selectedDuration == 30 ? Color(0xff8F3F71) : Colors.black87),minFontSize: 18,maxFontSize: 20,)))),

                              Expanded(flex: 2, child: Center(child:
                              GestureDetector(
                                  onTap:() {
                                    setState(() => getStockChartData(selectedSubcat,180));
                                  },
                                  child: AutoSizeText("6 أشهر",style: TextStyle(fontSize: 17.sp,   fontWeight: FontWeight.bold,
                                      color: selectedDuration == 180 ? Color(0xff8F3F71) : Colors.black87),minFontSize: 18,maxFontSize: 20,)))),

                              Expanded(flex: 2, child: Center(child:
                              GestureDetector(
                                  onTap:() {
                                    setState(() => getStockChartData(selectedSubcat,365));
                                  },
                                  child: AutoSizeText("سنة",style: TextStyle( fontSize: 17.sp,  fontWeight: FontWeight.bold,
                                      color: selectedDuration == 365 ? Color(0xff8F3F71) : Colors.black87),minFontSize: 18,maxFontSize: 20,)))),
                            ],
                          )),
                      Directionality(
                            ...
                            SizedBox(
                              ...
                              SfCartesianChart(
                                  ...
                                  primaryYAxis: NumericAxis(
                                    //    minimum: 0,
                                      title: AxisTitle(text: indicators[selectedSubcat].unit,textStyle: GoogleFonts.tajawal(textStyle: TextStyle(fontSize: 17))),
                                  ...
                                  // Chart title
                                  title: ChartTitle(text: indicators[selectedSubcat].name.toString(),textStyle: GoogleFonts.tajawal(textStyle: TextStyle(fontSize: 17))),
                                  // Enable legend
                                  legend: Legend(
            ...
            Padding(
                ...
                child:
                TableViewWidget(name:indicators[selectedSubcat].name.toString() ,

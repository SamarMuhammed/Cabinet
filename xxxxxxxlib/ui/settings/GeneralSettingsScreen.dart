...
class GeneralSettingsScreen extends StatefulWidget {
  const GeneralSettingsScreen({Key? key,required this.settingD}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: AutoSizeText(widget.settingD.name.toString(),style:GoogleFonts.tajawal(textStyle: TextStyle(fontSize: 17)),minFontSize: 18,),

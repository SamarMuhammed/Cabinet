  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Contact Us",style:GoogleFonts.tajawal(textStyle: TextStyle(fontSize: 20)),),
                    ...
                    Center(
                      child: Padding(
                        ...
                        child: Text(
                          ...
                          'The Headquarter of Egyptian Cabinet, The Government District, The New Administrative Capital, Cairo',
                          ...
                          RichText(
                            // textAlign: TextAlign.center,
                              text: TextSpan(children: [
                                ...
                                TextSpan(
                                    text:"Government complains portal",
                                    style: TextStyle(
                                      fontSize: 15,

      ...
      if(duration == 180 || duration == 365)
        {
          for (var i = data.indicators![0].data!.length-1 ;i>=0;i--)
           ...
           // print(data.indicators![0].data![i].date!.toString());
            items.add( listItem(data.indicators![0].data![i].date!, data.indicators![0].data![i].value!,data.indicators![0].data![i].id!));
...
//print(DateTime.parse( m.date!.toString()));
  ...
  Widget build(BuildContext context) {
    ...
    if ( categories.length >0 && seriesData.length > 0 && subCategories.length >0 && data.indicators!.length >0) {
      ...
      return
        Scaffold(
          appBar: AppBar(
            ...
            title: Text("أسواق المال",style:GoogleFonts.tajawal(textStyle: TextStyle(fontSize: 17))),
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              [for (int i = 0; i < subCategories.length; i++)
                                ChoiceChip(label: AutoSizeText(
                                    subCategories[i].name.toString(),minFontSize: 15,maxFontSize: 17,),
                                    selected: selectedSubcat == i
                                    ,
                                    selectedColor: const Color(0xff8F3F71),
                                    labelStyle: TextStyle(
                                        color: selectedSubcat == i ? Colors
                                            .white : Colors.black,
                                        fontSize: 15.sp),
                                    onSelected: (value) {
                                      setState(() {
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                  ...
                                  child: Column(
                                    children: [
                                      Center(child: AutoSizeText("نسبة التغير",
                                        style: TextStyle(
                                            color: Color(0xff0D005F),
                                            fontSize: 18.sp,
                                            fontWeight: FontWeight.bold),minFontSize: 18,maxFontSize: 20,)),
                                      Center(child: Padding(
                                        ...
                                        child: AutoSizeText(
                                          ...
                                          style: TextStyle(
                                              color: Color(0xff0D005F),
                                              fontSize: 16.sp,
                                              fontWeight: FontWeight.bold),minFontSize: 16,maxFontSize: 18,),
                                      ),
                                      ),
                                    ],
                                  )),
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Icon(Icons.arrow_downward,
                                              color: Colors.red,)
                                            ,
                                            AutoSizeText(data.indicators![1].data![0]
                                                .value.toString()
                                                , style: TextStyle(fontSize: 18.sp,
                                                    color: data.indicators![1]
                                                        .data![0].value! >= 0
                                                        ? Colors.green
                                                        : Colors.red
                                                    ,
                                                    fontWeight: FontWeight
                                                        .bold),minFontSize: 18,maxFontSize: 20,),
                                            AutoSizeText(data.indicators![1].unit
                                                .toString(),
                                                style: TextStyle(fontSize: 18.sp,
                                                    color: data.indicators![1]
                                                        .data![0].value! >= 0
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              AutoSizeText(
                                                  data.indicators![0].data![data
                                                      .indicators![0].data!
                                                      .length - 1].value
                                                      .toString()
                                                  ,
                                                  style: TextStyle(fontSize: 18.sp,
                                                      color:   data.indicators![1].data![0]
                                                          .value!  >=
                                                          0 ? Colors.green
                                                          : Colors.red
                                                      ,
                            ...
                            Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    AutoSizeText("المدى:", style: TextStyle(
                                        fontWeight: FontWeight.bold),minFontSize: 16,maxFontSize: 18,))),

                                    Expanded(flex: 2, child: Center(child:
                                    GestureDetector(
                                        onTap: () {
                                          setState(() => getStockChartData(
                                              selectedSubcat, 7));
                                        },
                                    ...
                                    GestureDetector(
                                        ...
                                        child: AutoSizeText("شهر", style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            color: selectedDuration == 30
                                                ? Color(0xff8F3F71)
                                                : Colors.black87),minFontSize: 16,maxFontSize: 18,)))),
                                    ...
                                    GestureDetector(
                                        ...
                                        child: AutoSizeText("6 أشهر", style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                    ...
                                    GestureDetector(
                                        ...
                                        child: AutoSizeText("سنة", style: TextStyle(
                                            fontWeight: FontWeight.bold,

  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Details", style:GoogleFonts.tajawal(textStyle: TextStyle(fontSize: 20.sp))
        ),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            ...
                            NetworkImage(
                                DioBaseService().Cap_Upload_URL+widget.minister.photo!
                            ),
                            fit: BoxFit.fill
                        ),
                      ),
          ...
          /*    Row(
              ...
              Row(
                ...
                children: [
                  Expanded(
flex:1,
                      child: Icon(Icons.phone,color: Color(0xffb5102b),)),
                  Expanded(
                    flex: 12,
                    child: Text(
...
if(widget.minister.fax !=null)
              Row(
                ...
                children: [
                  Expanded(
                      flex:1,
                      child: Icon(Icons.fax,color: Color(0xffb5102b),)),
                  Expanded(
                    flex: 12,
                    child: Text(
              ...
              Row(
                ...
                children: [
                  Expanded(
                      flex:1,
                      child: Icon(Icons.email,color: Color(0xffb5102b),)),
                  Expanded(
                    flex: 12,
                    child:   RichText(
              ...
              Row(
                ...
                children: [
                  Expanded(
                      flex:1,
                      child: Icon(Icons.home,color: Color(0xffb5102b),)),
                  Expanded(
                    flex: 12,
                    child: InkWell(
                      onTap: ()=>{
                        launch( widget.minister.homepage)
                      },
                      child: Text(

  ...
  Widget build(BuildContext context) =>
      Scaffold(
          appBar: AppBar(
            ...
            title: Text("Ministerial Formation",
                    ...
                    InkWell(
                      ...
                      onTap: () {
                        ...
                        { Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (ctx) =>
                                MinisterDetails(minister: value!),
                          ),
                        )});
                      },
                      ...
                      Padding(
                        ...
                        child: ClipRRect(
                          ...
                          child: Container(
                            ...
                            height: MediaQuery.of(context).orientation == Orientation.portrait ? MediaQuery.of(context).size.height/6:MediaQuery.of(context).size.height/5,

...
class _PoliciesTabsScreenState extends State<PoliciesTabsScreen> {
  ...
  void initState() {
    ...
    List<IndCategory> c;
    categories.add(
        new IndCategory(id: 1, name: "Egypt Vision2030", isSelected: true));
    categories.add(new IndCategory(
        id: 2, name: "State Ownership Policy", isSelected: false));
    categories.add(new IndCategory(
        id: 3, name: "Government Action Plan", isSelected: false));
    categories.add(new IndCategory(
        id: 4, name: "Annual Government Report ", isSelected: false));
  }

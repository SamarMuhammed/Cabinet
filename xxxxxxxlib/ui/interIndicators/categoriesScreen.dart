...
class InterCategoriesScreen extends StatefulWidget {
  ...
  const InterCategoriesScreen({Key? key, required this.index, required this.selectedTopics}) : super(key: key);
...
class _InterCategoriesScreenState extends State<InterCategoriesScreen> {
  ...
  Future<List<IndCategory>> loadCategories() async{
    ...
    categories =await InterIndService().getInterIndCategories("1");
    print(categories.length);
    completer.complete(await InterIndService().getInterIndCategories("1"));

...
class _TabsScreenState extends State<TabsScreen> {
  ...
  void initState() {
    ...
    super.initState();
    List<IndCategory> c ;
    categories.add(new IndCategory(id: 1,name: "Biography",isSelected: true));
    categories.add(new IndCategory(id: 2,name: "Mandates",isSelected: false));
    categories.add(new IndCategory(id: 3,name: "Speeches",isSelected: false));

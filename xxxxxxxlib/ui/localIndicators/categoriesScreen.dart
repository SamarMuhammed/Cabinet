...
class LocalIndCategories extends StatefulWidget {
  ...
  const LocalIndCategories({Key? key, required this.selectedTopics}) : super(key: key);
          ...
          if (snapshot.hasData) {
            ...
            return   Scaffold(
              ...
              appBar: AppBar(
                ...
                title: Text("Indicators",style:GoogleFonts.tajawal(textStyle: TextStyle(fontSize: 17.sp))
                ),
                  ...
                  SizedBox(
                    ...
                    child:  TabBarView(
                      children: [
                        ...
                        InterCategoriesScreen(index: 0,selectedTopics: widget.selectedTopics,)
                      ],
                    ),
                  ),

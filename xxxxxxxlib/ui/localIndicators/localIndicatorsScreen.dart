...
class LocalIndicators extends StatefulWidget {
  ...
  const LocalIndicators({Key? key, required this.selectedTopics}) : super(key: key);
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                [for (final cat in categories)
                                  ChoiceChip(label: AutoSizeText(cat.
                                  name.toString(),minFontSize: 17,maxFontSize: 19,),selected: cat.isSelected!
                                      ,selectedColor: const Color(0xfff78c9c),
                                      labelStyle: TextStyle(color: cat.isSelected == true ? Colors.white:Colors.black,
                                          fontSize: 17.sp),
            ...
            onTap: ()
            {
              Navigator.push(
                ...
                MaterialPageRoute(builder: (context) =>
                    ChartView(subCatID: int.parse(subCategories[index].id.toString())
                    ...
                    child: Column(
                      children: [
                        Padding(
                          ...
                          child: AutoSizeText(subCategories[index].name.toString(),
                        ...
                        Padding(
                          ...
                          child: AutoSizeText(subCategories[index].indicator!.name.toString(),
                        ...
                        Padding(
                          padding:  EdgeInsets.only(top: 5.0.r),
                          child: AutoSizeText(subCategories[index].indicator!.value.toString() + " " + subCategories[index].indicator!.unit.toString() ,
                        ...
                        Padding(
                          ...
                          child: Wrap(
                            ...
                            children:[
                              ...
                              AutoSizeText(subCategories[index].indicator!.date.toString() ,

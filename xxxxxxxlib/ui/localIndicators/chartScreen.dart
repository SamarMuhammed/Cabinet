          ...
          if (data != null && seriesData.length > 0) {
            return Scaffold(
              appBar: AppBar(
                ...
                title: AutoSizeText("Details", style:TextStyle(fontSize: 20.sp,fontFamily: 'Cairo'),minFontSize: 16,maxFontSize: 18,),
                  ...
                  children: [
                        ...
                        child: Container(
                          ...
                          Row(
                            children: [
                              Expanded(
                                  flex: 2,
                                  child: Center(child: AutoSizeText("Last Value",
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                    ...
                                    alignment: Alignment.topLeft,
                                    child: Padding(
                                      padding:  EdgeInsets.only(top: 8.0.r,left: 10.r),
                                      child: AutoSizeText(
                                        "Source : " + data.source.toString(), style:
                    ...
                    Padding(
                      ...
                      child: Container(
                          height: 30.h,
                          alignment: Alignment.topLeft,
                          child:  AutoSizeText("Table", style:
                          TextStyle(fontWeight: FontWeight.bold,
                              fontSize: 18.sp
                              ,fontFamily: 'Cairo',

...
class _MediaDetailsState extends State<MediaDetails> {
  ...
  void initState() {
    ...
    String text = widget.mediaD.hashtags?.isEmpty == false
        ? widget.mediaD.hashtags.toString()
        : "";
    result = text.split(',');
                      ...
                      .map((item) => InkWell(
                            onTap: () async {
                              await showDialog(
                                  context: context,
                                  builder: (_) =>
                                      ImageDialog(item.attach.toString()));
                            },
                            child: Container(
                              child: Center(
                                  child: Image.network(
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        (widget.mediaD.attachments![0].playingstatus == 1)
                        ...
                        IconButton(
                            onPressed: () async {
                              if (widget.mediaD.attachments![0].playingstatus ==
                                  0) {
                                await player.stop();
                                await player.play(
                                  widget.mediaD.attachments![0].attach!
                                      as Source,
                                );
                                setState(() {
                                  for (int i = 0;
                                  ...
                                  widget.mediaD.attachments![0].playingstatus =
                                      1;
                                });
                              } else if (widget
                                      .mediaD.attachments![0].playingstatus ==
                                  1) {
                                player.stop();
                                setState(() {
                                  for (int i = 0;
                            ...
                            icon:
                                widget.mediaD.attachments![0].playingstatus == 0
              ...
              child: Row(
                children: [
                  Expanded(
                      ...
                      child: Padding(
                        ...
                        child: Row(children: [
                          ...
                          Text(
                            widget.mediaD.createDate.toString(),
                        ...
                        child: IconButton(
                            onPressed: () async {
                              ...
                              if (widget.Type == 'Audio')
                                urlimage =
                                    'http://new.idscapp.gov.eg/images/media.png';
                              else if (widget.Type == 'Video')
                                urlimage =
                                    'http://new.idscapp.gov.eg/images/media.png';
                              else if (widget.Type == 'Info')
                                urlimage = widget.mediaD.attachments![0].attach
                                    .toString();
                              ...
                              await Share.shareFiles([path],
                                  text:
                                      '${widget.mediaD.title.toString()} ${widget.mediaD.attachments![0].attach.toString()}\n'
                                      ' تطبيق IDSC'
                  ...
                  Expanded(
                      ...
                      child: IconButton(
                          onPressed: () async {
                            if (intbookmarks.contains(widget.mediaD.id) ==
                                true) {
                              var msg = await MediaService().unBookmarkMedia(
                                  userID: widget.userID,
                                  parentID:
                                      int.parse(widget.mediaD.id.toString()));
                              //  print(msg);
                              setState(() {
                                intbookmarks.remove(widget.mediaD.id);
                                (intbookmarks.contains(widget.mediaD.id) ==
                                    false);
                                getUserSavedMedia();
                              });
                              return showDialog<void>(
                                ...
                                builder: (BuildContext context) {
                                  return AlertDialog(
                                    ...
                                    .contains(widget.mediaD.id) ==
                                false) {
                              var msg = await MediaService().bookmarkMedia(
                                  userID: widget.userID,
                                  parentID:
                                      int.parse(widget.mediaD.id.toString()));
                              //  print(msg);
                          ...
                          icon: intbookmarks.contains(widget.mediaD.id)
                              ? Icon(
                                  Icons.bookmark,
                                  color: Colors.white,
                                  size: 30,

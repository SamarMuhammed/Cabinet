                ...
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                    builder: (ctx) => MediaDetails(
                        mediaD: item, userID: userID, Type: "Audio"),
                  ),
                );
              },
              child: Wrap(
                ...
                children: [
                  Padding(
                    padding: EdgeInsets.only(right: 14, left: 14, top: 14).r,
                    child: Container(
                      height: 150.h,
                      child: Card(

  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("تفاصيل السلسلة ",style:GoogleFonts.tajawal(textStyle: TextStyle(fontSize: 17))
          ,),
        ...
        actions: [
          ...
          },icon: const Icon(Icons.arrow_forward_ios,textDirection: TextDirection.ltr),color: Colors.black,)
        ],
      ...
      body:_isShownPw?Transform.scale(
        scale: 0.1,
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Padding(
                    padding: const EdgeInsets.only(top:36,right:30,left:8,bottom:14),
                    child: Container(
                      ...
                      child:ClipRRect(
                          ...
                          Image.network(Reportslist.icon!,
                            fit: BoxFit.cover,
                          )),
                    )
                ),
            ...
            Row(
              children: [
                Padding(
                  ...
                  child: Column(
                    children: [
                      Text(Reportslist.name.toString(),style: TextStyle(fontSize: 20),),
                    ],
                  ),
                ),
               // SizedBox(width: 190,),
            ...
            ,
            Padding(
              padding: const EdgeInsets.only(right:35,top:14,left:16),
              child: Row(
                children: [
                  (Reportslist.description!=null)?
                  Expanded(

                    child: Text(Reportslist.description.toString(), //put your own long text here.
                      //maxLines: 3,
                    ...
                    child: Text("لا يوجد وصف", //put your own long text here.
                      //maxLines: 3,
                      //  overflow:TextOverflow.clip,
            ...
            Row(
              children: [
                Padding(
                  padding: const EdgeInsets.only(right:40,top:14,left:16),
                  child: Text("الاصدارات",
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (builder)=>ReportsDetailsScreen(ReportsD:Reportslist.reports![index],userID: userID,)));
                        ...
                        child: Card(
                          ...
                          child: Row(
                            children: <Widget>[
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child:  ClipRRect(
                                          ...
                                          child:Image.network(Reportslist.reports![index].image.toString(),
                                            fit: BoxFit.cover,
                                          )
                                      ),
                                    ),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        //height: 20,
                                        // color:Colors.red,
                                        child:Reportslist.reports![index].hashtags==null?Text(""):  SingleChildScrollView(
                                          scrollDirection: Axis.horizontal,
                                          child: Row(
                                            children: <Widget>[
                                              for(var item in Reportslist.reports![index].hashtags!.split((',')) )
                                                Padding(
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Expanded(
                                              flex:5,
                                              child: Text(Reportslist.reports![index].title.toString(), maxLines: 2,
                                                overflow: TextOverflow.ellipsis,
                                                textDirection: TextDirection.rtl,
                                                style:TextStyle(fontSize: 17,color: Color(0xff212121)),)),
                                      ...
                                      Reportslist.reports![index].hashtags==null?        Row(
                                        children: [
                                          Row(
                                            children: [
                                              Icon(Icons.calendar_today,size: 15,),
                                              AutoSizeText(Reportslist.reports![index].createDate.toString(),minFontSize: 15,),
                              ...
                              Column(
                                children: [
                                  Reportslist.reports![index].hashtags==null?  Padding(
                                    padding: const EdgeInsets.only(top:5),
                                    child:  IconButton(onPressed: () async {

                                      if(intreportsbookmarks.contains(Reportslist.reports![index].id)==true) {
                                        var msg= await ReportsService().unBookmarkReports(
                                            userID: userID,
                                            parentID: int.parse(
                                                Reportslist.reports![index].id.toString()));
                                        //  print(msg);
                                        setState(() {
                                          intreportsbookmarks.remove(Reportslist.reports![index]
                                              .id);
                                          (intreportsbookmarks.contains(Reportslist.reports![index].id)== false);
                                          getUserSavedReports();
                                        });
                                      ...
                                      }else if(intreportsbookmarks.contains(Reportslist.reports![index].id)==false){
                                        var msg= await ReportsService().bookmarkReports(userID: userID, parentID: int.parse(Reportslist.reports![index].id.toString()));
                                        //  print(msg);
                                        setState(() {
                                          (intreportsbookmarks.contains( Reportslist.reports![index].id)== true);
                                          getUserSavedReports();
                                        });
                                        return showDialog<void>(
                                            context: context,
                                        ...
                                        icon:intreportsbookmarks.contains(Reportslist.reports![index].id) ? Icon(Icons.bookmark, color: Color(0xff212121),

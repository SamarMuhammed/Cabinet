...
Vision2030 vision2030FromJson(String str) => Vision2030.fromJson(json.decode(str));
String vision2030ToJson(Vision2030 data) => json.encode(data.toJson());
class Vision2030 {
  Vision2030({
    int? id,
    int? ownerId,
  ...
  Vision2030.fromJson(dynamic json) {
    _id = json['id'];

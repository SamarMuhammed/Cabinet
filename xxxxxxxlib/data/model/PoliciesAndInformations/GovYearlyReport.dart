...
GovYearlyReport govYearlyReportFromJson(String str) => GovYearlyReport.fromJson(json.decode(str));
String govYearlyReportToJson(GovYearlyReport data) => json.encode(data.toJson());
class GovYearlyReport {
  GovYearlyReport({
    int? id,
    int? ownerId,
    String? titleA,
  ...
  GovYearlyReport.fromJson(dynamic json) {
    _id = json['id'];
  ...
  GovYearlyReport copyWith({  int? id,
    int? ownerId,
    String? titleA,
    String? titleE,
    String? contentA,
